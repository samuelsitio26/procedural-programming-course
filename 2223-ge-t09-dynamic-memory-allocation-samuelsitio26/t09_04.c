...
int main(int _argc, char **_argv) 
{
  ...
  while (looping != 1)
  {
    ...
    else if(strcmp(janring,"find-student-by-id")==0)
    {
     janring = strtok(NULL, "#");
     find_student_by_id(student , student_size, janring);
      
    }
    else if(strcmp(janring,"find-course-by-code")==0)
    {
      janring = strtok(NULL, "#");
     find_course_by_code(course , course_size, janring); 
    }
